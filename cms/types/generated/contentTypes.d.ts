...
export interface ApiConsultationRequestConsultationRequest
  ...
  info: {
    description: 'Y\u00EAu c\u1EA7u t\u01B0 v\u1EA5n / li\u00EAn h\u1EC7 g\u1EEDi t\u1EEB website';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    serviceInterest: Schema.Attribute.Relation<
      'manyToOne',
      'api::service.service'
    >;
    status: Schema.Attribute.Enumeration<['moi', 'da-lien-he', 'hoan-thanh']> &
      Schema.Attribute.DefaultTo<'moi'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCourseRegistrationCourseRegistration
  ...
  info: {
    description: '\u0110\u0103ng k\u00FD kh\u00F3a \u0111\u00E0o t\u1EA1o';
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Th\u01B0 vi\u1EC7n t\u00E0i li\u1EC7u: v\u0103n b\u1EA3n ph\u00E1p lu\u1EADt, ti\u00EAu chu\u1EA9n, b\u00E1o c\u00E1o...';
...
export interface ApiGisLayerGisLayer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'L\u1EDBp d\u1EEF li\u1EC7u b\u1EA3n \u0111\u1ED3 cho WebGIS (MVP: l\u01B0u GeoJSON tr\u1EF1c ti\u1EBFp, n\u00E2ng c\u1EA5p l\u00EAn PostGIS sau)';
    displayName: 'GIS Layer';
    pluralName: 'gis-layers';
    singularName: 'gis-layer';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    color: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'#1f6d45'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultVisible: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    fillOpacity: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiMediaAlbumMediaAlbum extends Struct.CollectionTypeSchema {
  collectionName: 'media_albums';
  info: {
    description: 'Album \u1EA3nh / video theo ch\u1EE7 \u0111\u1EC1';
    displayName: 'Media Album';
    pluralName: 'media-albums';
    singularName: 'media-album';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0110\u1ED1i t\u00E1c trong n\u01B0\u1EDBc / qu\u1ED1c t\u1EBF';
    displayName: 'Partner';
    pluralName: 'partners';
  ...
  attributes: {
    cooperationContent: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    ...
    order: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['trong-nuoc', 'quoc-te']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Nh\u00E2n s\u1EF1 c\u1EE7a Trung t\u00E2m (Ban Gi\u00E1m \u0111\u1ED1c, Nh\u00E0 khoa h\u1ECDc, Nghi\u00EAn c\u1EE9u vi\u00EAn, C\u1ED9ng t\u00E1c vi\u00EAn)';
    displayName: 'Person';
    pluralName: 'people';
    singularName: 'person';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    researchFields: Schema.Attribute.Text;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    leadResearcher: Schema.Attribute.String;
    level: Schema.Attribute.Enumeration<
      ['nha-nuoc', 'bo', 'tinh', 'dai-hoc', 'quoc-te', 'doanh-nghiep']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    partnerInstitutions: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'S\u1EA3n ph\u1EA9m khoa h\u1ECDc: b\u00E0i b\u00E1o, s\u00E1ch, gi\u00E1o tr\u00ECnh, b\u00E1o c\u00E1o, b\u1EA3n \u0111\u1ED3, CSDL, ph\u1EA7n m\u1EC1m, s\u00E1ng ch\u1EBF';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Nh\u00F3m d\u1ECBch v\u1EE5 t\u01B0 v\u1EA5n / chuy\u1EC3n giao c\u00F4ng ngh\u1EC7';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiTrainingCourseTrainingCourse
  ...
  info: {
    description: 'Kh\u00F3a \u0111\u00E0o t\u1EA1o (GIS, vi\u1EC5n th\u00E1m, LiDAR, UAV, m\u00F4i tr\u01B0\u1EDDng...)';
